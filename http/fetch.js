...
// fetch('https://http.cat/200').then((data)) => {
//     console.log(data);
// }
...
//     // use a tick (`) instead of double quotes to allow for Regex (the $(variableName) tells Javascript to input a specific variable.
...
// //     fetch(`https://api.thecatapi.com/v1/images/search?limit=${numCats}&api_key=${apiKey}`).then((res) => res.json()).then((data) =>{
...
// //       fetch(`https://api.thecatapi.com/v1/images/search?limit=${numCats}&breed=${breed}&api_key=${apiKey}`).then((res) => res.json()).then((data) =>{
// //           for (let i = 0; i < data.length; i++){
// //               console.log(data);
// //               const imgTag = document.createElement('img');
// //               imgTag.width = 200;
...
//     const numCats = document.getElementById('img-num').value;
//     const breed = document.getElementById('breed').value;
//       fetch(`https://api.thecatapi.com/v1/images/search?limit=${numCats}&breed=${breed}`,{
//         method: 'POST',
//         headers: {
//             'x-api-key': apiKey
...
//               upVoteBtn.innerText = "^";
//               upVoteBtn.onclick = () =>{
//                 console.log('upvoting this image!');
//               }
...
//               downVoteBtn.onclick = () => {
//                 console.log("downvoting this image!");
//               }
...
import {fetchCatsFn} from "./fetchCats";
